      ...
      >
        <div className="flex justify-between items-center px-8 py-4 max-w-7xl mx-auto w-full">
          ...
          <div className="hidden md:flex items-center gap-4">
            <Link
              to="/login"
              className="font-bold text-[#14003c] dark:text-purple-300 hover:opacity-80 transition-opacity"
            >
              Log in
            </Link>
            <Link
              to="/signup"
              className="bg-[#14003c] text-white px-6 py-2.5 rounded-full font-bold hover:bg-[#2c046f] hover:scale-105 active:scale-95 transition-all shadow-lg shadow-[#14003c]/20"
            >
              Start Pooling
            </Link>
          </div>
